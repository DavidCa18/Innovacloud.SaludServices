...
namespace Innovacloud.SaludServices.Servicio.Token
{

    public class GestionToken : ServiceAuthorizationManager
    {
        private static string cadenaSeguridad = "Innovacloud//SingleSignOn//{2020}";
        private static string entrada = "DataInnvacloud";
